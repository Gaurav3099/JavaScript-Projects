const text = [
  ...
  var amount = document.getElementById('no-of-para');
  var generate = document.getElementById('generate');
  var lorem_text = document.getElementById('lorem-text');
  ...
  generate.addEventListener('click', function(e){
      ...
      if(isNaN(val) || val < 0 || val >9){
          lorem_text.innerHTML = `<p class="lorem-text">${text[random]}</p>`;
